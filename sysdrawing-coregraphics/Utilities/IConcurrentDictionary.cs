...
namespace System.Drawing
{
    ...
    internal delegate TValue KeyValueUpdate<TKey, TValue>(TKey key, TValue original);

    /// <summary> Provides a delegate that performs a test on key/value pair </summary>
	internal delegate bool KeyValuePredicate<TKey, TValue>(TKey key, TValue original);
    ...
    /// </summary>
	internal interface IConcurrentDictionary<TKey, TValue> : IDictionaryEx<TKey, TValue>
    {
        /// <summary>
